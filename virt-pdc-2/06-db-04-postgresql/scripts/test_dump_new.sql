...
--
-- Name: orders_old_1; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.orders_old_1 (
    CONSTRAINT orders_1_price_check CHECK ((price > 499))
)
INHERITS (public.orders_old);


ALTER TABLE public.orders_old_1 OWNER TO postgres;

--
-- Name: orders_old_2; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.orders_old_2 (
    CONSTRAINT orders_2_price_check CHECK ((price <= 499))
)
INHERITS (public.orders_old);


ALTER TABLE public.orders_old_2 OWNER TO postgres;
...
--
-- Name: orders_old_1 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_old_1 ALTER COLUMN id SET DEFAULT nextval('public.orders_id_seq'::regclass);


--
-- Name: orders_old_1 price; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_old_1 ALTER COLUMN price SET DEFAULT 0;


--
-- Name: orders_old_2 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_old_2 ALTER COLUMN id SET DEFAULT nextval('public.orders_id_seq'::regclass);


--
-- Name: orders_old_2 price; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_old_2 ALTER COLUMN price SET DEFAULT 0;
...
--
-- Data for Name: orders_old_1; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orders_old_1 (id, title, price) FROM stdin;
2	My little database	500
6	WAL never lies	900
8	Dbiezdmin	501
\.
...
--
-- Data for Name: orders_old_2; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orders_old_2 (id, title, price) FROM stdin;
1	War and peace	100
3	Adventure psql time	300
4	Server gravity falls	300
5	Log gossips	123
