...
COPY public.clients (id, "фамилия", "страна", "заказ") FROM stdin;
...
--
-- Name: indcount; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX indcount ON public.clients USING btree ("страна");
